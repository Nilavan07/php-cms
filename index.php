...
<body>
  <header class="hero">
    <div class="container">
      <h1>Hello, I'm <span>Seranilavan</span></h1>
  ...
  <main class="container">
          ...
          <article class="project-card">
            <?php if($project['photo']): ?>
              <div class="project-image">
                <img src="admin/image.php?type=project&id=<?php echo $project['id']; ?>&width=800&height=500" 
                     alt="<?php echo htmlspecialchars($project['title']); ?>">
                <span class="project-type"><?php echo $project['type'] ?? 'Project'; ?></span>
              </div>
            <?php endif; ?>
        ...
        <?php while($skill = mysqli_fetch_assoc($skills_result)): ?>
          <div class="skill-item">
            ...
            <div class="skill-level">
              <div class="skill-progress" style="width: <?php echo htmlspecialchars($skill['skill_level']); ?>%">
    ...
    <?php if(isset($_SESSION['form_message'])): ?>
        <div class="message-alert <?= $_SESSION['form_message']['type'] ?>">
